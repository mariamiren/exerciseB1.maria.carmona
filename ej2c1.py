...
def convert_to_integer():
    ...
    assert convert_to_integer("5").__contains__("An unexpected error has ocurred:"), "convert _to_integer does not return the correct value for input['5']. It should be 'An unexpected error has ocurred:'"
    pass
